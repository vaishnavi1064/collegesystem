...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href=""><i class="fa fa-book" aria-hidden="true"></i> IIIT Sonepat</a></h1>

			</div>
			<div class="w3layouts_header_right">
		   </div>
			<ul class="agile_forms">
				<li><a class="active" href="./Login/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i>  Log In To IIIT Sonepat</a> </li>
				<!-- <li><a class="active" href="./Login/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Admin Log In</a> </li> -->
			</ul>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='100' data-delay='.5' data-increment="1">7000</div>
				
				<h4 class="stats-info">FOREIGN FOLLOWERS</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-book" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='1000' data-delay='.5' data-increment="1">10000</div>
				
				<h4 class="stats-info">CLASSES COMPLETE</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-trophy" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='600' data-delay='.5' data-increment="10">31000</div>
				
				<h4 class="stats-info">STUDENTS ENROLLED</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
					<i class="fa fa-user" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='50' data-delay='.5' data-increment="1">500</div>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Our Skilled Team</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/t1.png" alt="">
				  <h5>Dr.Chanchal Kumar</h5>
				  <div class="about_opa">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/t2.png" alt="">
				  <h5>Dr.Mukesh Mann</h5>
				  <div class="about_opa">
					<p>Assistant Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/t3.png" alt="">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/t4.png" alt="">
				  <h5>Dr.Syed Ghufran Hashmi</h5>
				  <div class="about_opa">
					<p>Assistant Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/t5.png" alt="">
				  <h5>Dr.Bhoopesh Singh Bhati</h5>
				  <div class="about_opa">
					<p>Assistant Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/t6.png" alt="">
				  <h5>Dr.Wakar Ahmad</h5>
				  <div class="about_opa">
					<p>Assistant Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
