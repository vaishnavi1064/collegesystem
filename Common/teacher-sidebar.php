		...
		<nav id="sidebarMenu" class="">
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						<a class="nav-link" href="../teacher/notes.php">
						<span data-feather="notes"></span>
						<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> Notes
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/videos.php">
						<span data-feather="videos"></span>
						<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> Videos
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/assessment.php">
						<span data-feather="assessment"></span>
						<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> Assessments
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/teacher-time-table.php">
						<span data-feather="users"></span>
						<i class="fa fa-users mr-2" aria-hidden="true"></i> Time Table
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/teach-bot.php">
